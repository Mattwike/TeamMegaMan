...
public class SmallYellowDiamond : IEnemySprite
{
    int currentFrame;
    int totalFrame;
    int delayCounter;
    ...
    int itemSizeX;
    int itemSizeY;
    public SmallYellowDiamond(Texture2D texture)
    {
        itemSheet = texture;
        x = 400;
        y = 90;
    ...
    public void Draw(SpriteBatch _spriteBatch, bool flipHorizontally, bool flipVertically)
    {
        ...
        if (currentFrame < 5)
        {
            ...
            sourceRectangle = new Rectangle(36, 4, 10, 12);
        }
        else
        {
            destinationRectangle = new Rectangle((int)x, (int)y, itemSizeX, itemSizeY);
            sourceRectangle = new Rectangle(50, 4, 10, 12);
        }
