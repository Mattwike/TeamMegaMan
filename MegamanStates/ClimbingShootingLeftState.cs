...
{
    public class ClimbingShootingLeftMegamanState : IMegamanState
    {
        private Megaman megaman;
        public ISprite Sprite;

        public ClimbingShootingLeftMegamanState(Megaman Megaman)
        {
            megaman = Megaman;
        ...
        public void Draw(SpriteBatch _spriteBatch, Color currentColor)
        {
            ...
            Sprite.Draw(_spriteBatch, true, false, currentColor);
        }
